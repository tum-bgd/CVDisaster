...
split_mapping = {
    "val10": ["train_10", "val_10"],
    "val20": ["train_20", "val_20"],
    "val30": ["train_30", "val_30"],
    "val40": ["train_40", "val_40"],
    "val50": ["train_50", "val_50"],
    "val60": ["train_60", "val_60"],
    "val100": ["train_100", "val_100"],
    "subarea1": ["train_subarea1", "val_subarea1"],
    "subarea2": ["train_subarea2", "val_subarea2"],
    "subarea3": ["train_subarea3", "val_subarea3"],
    "subarea4": ["train_subarea4", "val_subarea4"],
    "subarea5": ["train_subarea5", "val_subarea5"]
}


class CVDisasterDatasetTrain(Dataset):
    ...
    def __init__(self,
        ...
        self.df = pd.read_csv(f'{data_folder}/{split_mapping[split_key][0]}.csv', header=None, names=['sat', 'ground'])
    ...
    def __getitem__(self, index):
        ...
        query_img = cv2.cvtColor(query_img, cv2.COLOR_BGR2RGB)[160:350, :, :]
...
class CVDisasterDatasetEval(Dataset):
    def __init__(self,
                 data_folder,
                 split,
                 img_type,
        ...
        if split == 'train':
            ...
            self.df = pd.read_csv(f'{data_folder}/{split_mapping[split_key][1]}.csv', header=None, names=['sat', 'ground'])
